...
./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 32770
// there are no parameter indicates the path of log file
// the log of search process can be found in benchmark_server.out
./rpc_client 2 /tmp/my.cdb 000

./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 65550
./rpc_client 2 /tmp/my.cdb 000

./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 131090
./rpc_client 2 /tmp/my.cdb 000

./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 262170
./rpc_client 2 /tmp/my.cdb 000

./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 524290
./rpc_client 2 /tmp/my.cdb 000

./rpc_client 1 /tmp/my.cdb /tmp/filename_keywords.db benchmark_client.out 1048576
./rpc_client 2 /tmp/my.cdb 000
``` 
