...
namespace DistSSE {
    ...
    public:
        ...
        /**
         * search for w in Database
         * @param w the searching keyword
         * @return status, represents whether the update process success
         */
        ...
        /**
         * search for w in Database
         * @param tw the search token of keyword w
         * @param uc the numbers of update operations, represents the newest proof
         * @return status, represents whether the update process success
         */
        ...
        /**
         * search and verify, this funcion is indeed used to test the verify efficiency
         * @param w the keyword
         * @return status, represents whether the update process success
         */
